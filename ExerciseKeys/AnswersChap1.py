...
# print('A message"') > nothing is actually wrond with this: you can use double quotes inside single quotes and vice versa.
...
# Ex. 4: Can you make Python print the following graphic?
...
# Ex. 5: Write a program that assigns the result of `9.5 * 4.5 - 2.5 * 345.5 - 3.5` to a variable.
...
# Ex. 6: Define the variables `a=2`, b=`20007` and c=`5`. Using only the operations you learned about above,
...
# Ex.7: Define three variables names `var1`, `var2` and `var3`. 
...
# Ex. 8: Write a little program that can compute the surface of circle,
...
# Ex. 9: There is one operator (like the ones for multiplication and subtraction)
...
# Ex. 10: Write a code block that classifies a given amount of money into smaller monetary units.
