...
# Ex. 6: A hapax legomenon (often abbreviated to hapax) is a 
...
# Ex. 7: Inside the same module as the previous exercise (i.e.
...
# Ex. 8: Write a program that given a text file will create
...
# Ex. 10: A sentence splitter is a program capable of splitting a text
